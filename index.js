...
- Для Telegram используй форматирование: *жирный* для заголовков, обычный текст для содержания
...
bot.onText(/\/start/, (msg) => {
  ...
  bot.sendMessage(
    chatId,
    `👋 *Привет!* Я медицинский ассистент по клиническим рекомендациям МЗ РФ.\n\n` +
    `Могу помочь:\n` +
    `• Найти актуальные КР по любому заболеванию\n` +
